...
//    self.lineRatio = lineRatio
    ...
    var stepWidth: CGFloat {
        ...
        return frame.size.width / CGFloat((data.points.count-1)*lineRatio)
    }
...
struct Line_Previews: PreviewProvider {
    static var previews: some View {
        GeometryReader{ geometry in
            Line(data: ChartData(points: [12,-230,10,54]), lineRatio: 1, frame: .constant(geometry.frame(in: .local)), touchLocation: .constant(CGPoint(x: 100, y: 12)), showIndicator: .constant(true))
